from models import Bancos, Conta, Historico, Tipos
from views import (buscar_historicos_entre_datas, criar_conta,
                   criar_grafico_por_conta, desativar_conta, listar_contas,
                   movimentar_dinheiro, total_contas, transferir_saldo)
...
class UI:
    ...
    def _movimentar_dinheiro(self):
        ...
        tipo = input().title()
        historico = Historico(conta_id=conta_id, tipo=Tipos(
            tipo), valor=valor, data=date.today())
